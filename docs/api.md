...
## Content Recommendations (Deprecated)

> **Note**: Social media integrations (YouTube, X/Twitter) have been removed. The `/api/recommendations/content` endpoint is no longer available.
