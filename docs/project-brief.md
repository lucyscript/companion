...
| ⬜ todo | `mobile-bottom-navigation` | frontend-engineer | Replace single-page layout with iOS-style bottom tab navigation (Journal, Schedule, Habits, Settings) for quick context switching on iPhone. |
