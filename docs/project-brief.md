...
| ⬜ todo | `content-recommendation-engine` | backend-engineer | Build recommendation system that matches YouTube videos and X threads to upcoming assignments/lectures. When user has DAT560 assignment due, surface relevant ML tutorials from subscribed channels. |
