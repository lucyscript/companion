...
| ⬜ todo | `study-plan-calendar-export` | backend-engineer | Add ICS export for generated study plans so users can add planned study sessions to iPhone Calendar in one tap (download endpoint + stable event IDs). |
