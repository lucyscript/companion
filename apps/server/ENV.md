...
- `POSTGRES_SNAPSHOT_SYNC_MS` (default: `30000`) — Interval for syncing SQLite runtime snapshots into PostgreSQL when `DATABASE_URL` is set
...
POSTGRES_SNAPSHOT_SYNC_MS=30000
