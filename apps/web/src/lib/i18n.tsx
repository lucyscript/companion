...
const NORWEGIAN_TRANSLATIONS: Record<string, string> = {
  ...
  "Import lecture events from TP into your schedule timeline.": "Importer forelesningshendelser fra TP til planlinjen din.",
  ...
  "No fixed sessions this day": "Ingen faste økter denne dagen",
