...
const NORWEGIAN_TRANSLATIONS: Record<string, string> = {
  ...
  "Your personal AI companion": "Din personlige AI-assistent",
  ...
  "Connect trusted external apps like GitHub and Notion.": "Koble til eksterne apper som GitHub og Notion.",
  ...
  "Event schedule via iCal subscription from TP.": "Hendelsesplan via iCal-abonnement fra TP.",
  "Gemini AI": "Gemini AI",
  ...
  "Use your Canvas root URL (no <code>/courses</code>).": "Bruk Canvas-rot-URL-en din (uten <code>/courses</code>).",
  ...
  "Connect external apps like GitHub, Notion, and Withings.": "Koble til eksterne apper som GitHub, Notion og Withings.",
  "Read more": "Les mer",
  "Import assignments and due dates into your schedule and deadline tracking.": "Importer oppgaver og frister til planen og fristsporing.",
  "Sync course names and modules to improve planning and chat context.": "Synk emnenavn og moduler for bedre planlegging og chat-kontekst.",
  "Set Canvas course scope so only selected courses are tracked.": "Sett Canvas-emneomfang slik at bare valgte emner spores.",
  "Connect external tools so Gemini can pull context from services you already use.": "Koble til eksterne verktøy slik at Gemini kan hente kontekst fra tjenester du allerede bruker.",
  "Use connected app data in chat, then write outcomes back into Companion schedules and deadlines.": "Bruk data fra tilkoblede apper i chat, og skriv resultatene tilbake til Companion-planer og frister.",
  "Tool exposure is budgeted automatically and scales with how many apps you connect.": "Verktøyeksponering budsjettstyres automatisk og skalerer med hvor mange apper du kobler til.",
  "Sync sleep, weight, and body metrics for trend-aware coaching.": "Synk søvn-, vekt- og kroppsmålinger for trendbasert coaching.",
  "Use health context in Gemini summaries and nudges.": "Bruk helsekontekst i Gemini-oppsummeringer og dytt.",
  "Disconnect anytime to stop future sync.": "Koble fra når som helst for å stoppe fremtidig synk.",
  "Import events from TP into your schedule timeline.": "Importer hendelser fra TP til planlinjen din.",
  "Keep schedule blocks refreshed when the iCal feed changes.": "Hold planblokker oppdatert når iCal-feeden endres.",
  "Use course context from TP when importing external deadlines.": "Bruk emnekontekst fra TP ved import av eksterne frister.",
  "Ask Gemini to create or update schedule blocks, deadlines, habits, and food logs.": "Be Gemini opprette eller oppdatere planblokker, frister, vaner og matlogger.",
  "Get summaries and coaching from your recent activity.": "Få oppsummeringer og coaching fra nylig aktivitet.",
  "Live hydration refreshes affected tabs after tool-driven updates.": "Live hydration oppdaterer berørte faner etter verktøydrevne endringer.",
  "Search repositories and read files for course and project context.": "Søk i repositorier og les filer for emne- og prosjektkontekst.",
  "Extract deadlines from docs and migrate them into your Companion schedule.": "Hent frister fra dokumenter og migrer dem til Companion-planen din.",
  "Read-only template by default to avoid unintended repository writes.": "Skrivebeskyttet mal som standard for å unngå utilsiktede repository-endringer.",
  "Search Notion pages and databases from your workspace.": "Søk i Notion-sider og databaser fra arbeidsområdet ditt.",
  "Read Notion docs in chat context for planning and study support.": "Les Notion-dokumenter i chat-kontekst for planlegging og studiestøtte.",
  "Use server-exposed create or update tools when available.": "Bruk server-eksponerte opprett- eller oppdateringsverktøy når tilgjengelig.",
  "Expose selected external tools to Gemini inside chat.": "Eksponer valgte eksterne verktøy for Gemini i chat.",
  "Use app context in planning flows and task execution.": "Bruk appkontekst i planleggingsflyter og oppgaveutførelse.",
  "Remove the app at any time from Connected Apps.": "Fjern appen når som helst fra Tilkoblede apper.",
  ...
  "AI tools & search": "AI-verktøy og søk",
  "Growth & habits": "Vekst og vaner",
  "Analytics dashboard": "Analyseoversikt",
  "Growth & analytics": "Vekst og analyse",
  "Custom chat themes": "Egendefinerte chat-temaer",
  "Withings health sync": "Withings helsesynk",
  ...
  "Schedule Planner": "Planlegger",
  "Upcoming events and schedule changes": "Kommende hendelser og planendringer",
  ...
  "Tomorrow's Schedule": "Morgendagens plan",
  "Yesterday's Schedule": "Gårsdagens plan",
  "Browse days": "Bla mellom dager",
  "{count} session": "{count} økt",
  "{count} sessions": "{count} økter",
  "Free day": "Fridag",
  "Offline": "Frakoblet",
  "Nothing scheduled today": "Ingenting planlagt i dag",
  "Nothing scheduled this day": "Ingenting planlagt denne dagen",
  "Enjoy your free time, or ask Gemini to plan something": "Nyt fritiden, eller be Gemini planlegge noe",
  "Load more": "Vis flere",
  "Show less": "Vis færre",
